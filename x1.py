...
code(Ch('      اداه الجلاد لرشق متابعين انستقرام       ')) 
#خلي بمكان Aegos اي شي تريده ينطبع
...
pas = input(A+' ادخل باسورد الاداه : ')
if pas == HAS:
 print('WELCOME IN TOOLS THE KING OF HACKSOSS ')
else:
 exit('ERROR PASSWORD FUCK YOU')
...
def send_follow(username,password,coo1,coo2):
    tragrt=input('ادخل يوزر الحساب الي تريد ترشق له متابعين : ')
    cookies = {
    ...
    if response.json()['status']=='success':
        print(f'تم رشق 300 متابع بواسطه الجلاد حاكم الهكسوس يفخم @{tragrt} ')
